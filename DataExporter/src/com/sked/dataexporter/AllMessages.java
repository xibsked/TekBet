...
public class AllMessages extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		uri = Uri.parse(allMsgs);
		msgThreadList = (ListView) findViewById(R.id.lvAllMessages);
		getThreadList();
	}
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.activity_all_messages, menu);
		return true;
	}
					...
					ListData country = new ListData(
							...
							((c.getString(c.getColumnIndexOrThrow("address")) != null ? (c
									...
									+ ((c.getString(c
											...
											.toString()).equalsIgnoreCase("1") ? "Received"
											: "Sent"), "", "", "", false);
