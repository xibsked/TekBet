...
public class AllSentMessages extends Activity {

	ListView msgThreadList;
	MyCustomAdapter adapter;
	ArrayList<ListData> listThread = new ArrayList<ListData>();
	String allRcvMsgs = "content://sms/sent/";
	Uri uri;

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_all_sent_messages);
		uri = Uri.parse(allRcvMsgs);
		msgThreadList = (ListView) findViewById(R.id.lvSentMessages);
		getThreadList();
	}
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.activity_all_sent_messages, menu);
		return true;
	}
